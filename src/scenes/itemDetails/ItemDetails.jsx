    ...
    >
        ...
        >
            ...
            flex = "1 1 50%" mb = "40px">
                ...
                <Box display = "flex" alignItems = "center" minHeight = "50px">
                    <Box display = "flex" alignItems = "center" border = {`1.5px solid bllack`} mr = "20px" p = "2px 5px" >
                    ...
                    minWidth: "150px",
                    padding: "10px 40px"}}
                    onClick = {() => dispatch(addToCart({item:{...item,count}}))}>ADD TO CART
                    </Button>
                </Box>
        ...
        <Box m = "20px 0">
            <Tabs value = {value} onChange = {handleChange}>
              ...
              <Tab label = "REVEIWS" value = "reviews"/>
